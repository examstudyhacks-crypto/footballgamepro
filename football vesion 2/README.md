...
This version includes a pinned `requirements.txt` to avoid Streamlit Cloud installing unstable latest dependency combinations. If deployment fails at **Installing requirements**, read `DEPLOYMENT_FIX.md`.

Recommended cloud setting: choose **Python 3.12** in Streamlit Cloud Advanced settings where available.
