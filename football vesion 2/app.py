...
def render_html(markup: str) -> None:
    """Render custom HTML safely without Markdown treating indented lines as code blocks."""
...
def show_stats(game: dict) -> None:
    ...
    with c2:
        ...
        st.dataframe(rows, hide_index=True, use_container_width=True) if rows else st.caption("No assists yet.")
